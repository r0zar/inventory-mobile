...
import { Waste } from "../shared/harvest.model";
...
@Component({
    moduleId: module.id,
    selector: "RemoveWaste",
    templateUrl: "./removewaste.component.html"
})
export class RemoveWasteComponent implements OnInit {
    ...
    *************************************************************/
    ngOnInit(): void {
        ...
        this._pageRoute.activatedRoute
            ...
            .forEach((params) => this._waste = new Waste({Id: params.id}));
    ...
    *************************************************************/
    onDoneButtonTap(): void {
        ...
        this._metrcService.removeWaste(this._waste)
