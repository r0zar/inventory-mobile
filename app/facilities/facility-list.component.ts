...
export class FacilityListComponent implements OnInit {
    ...
    *************************************************************/
    onFacilityItemTap(args: ListViewEventData): void {
        ...
        this._routerExtensions.navigate(["/facilities/facility-detail", tappedFacilityItem.Id],
        {
            animated: true,
            transition: {
                name: "slide",
    ...
    onAddButtonTap(): void {
        this._routerExtensions.navigate(["/facilities/facility-detail-edit", _.random(0, 999999999999999)],
            {
                animated: true,
                transition: {
                    name: "slideTop",
