...
export class MyListSelectorComponent implements OnInit {
    ...
    private _packageEditModel: Package;
    ...
    ngOnInit(): void {
        ...
        this._packageEditModel = this._packageEditService.getEditablePackageById(Number(packageId));
    }

    onSelectorTap(): void {
        const title = `Select Package ${capitalizeFirstLetter(this.tag)}`;
