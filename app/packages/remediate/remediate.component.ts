...
import { Remediation } from "../shared/package.model";
...
@Component({
    moduleId: module.id,
    selector: "Remediate",
    templateUrl: "./remediate.component.html"
})
export class RemediateComponent implements OnInit {
    private _remediation: Remediation;
    private _rooms: any;
    ...
    *************************************************************/
    onDoneButtonTap(): void {
        ...
        this._metrcService.remediatePackage(this._remediation)
